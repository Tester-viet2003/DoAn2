...
WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon - Phan Thanh Vit/a_S in thoi_btn btn-outline-danger not-hover px-2'))

WebUI.click(findTestObject('Object Repository/Page_/button_Kim tra xc thc'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_/span_Ti khon ca bn vn cha c xc thc. Hy kim _45bafc'), 'Tài khoản của bạn vẫn chưa được xác thực. Hãy kiểm tra lại cú pháp nhắn tin.')
