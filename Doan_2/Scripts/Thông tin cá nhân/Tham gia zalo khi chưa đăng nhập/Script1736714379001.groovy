...
WebUI.rightClick(findTestObject('Object Repository/Page_Hc bi/span_PT'))
...
WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon - Phan Thanh Vit/a_Kt ni zalo'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_ng nhp ti khon Zalo/p_ng nhp qua m QR'), 'Đăng nhập qua mã QR')
