...
WebUI.click(findTestObject('Object Repository/Page_Ci t ti khon - Phan Thanh Vit/span_Trng Tiu hc Thun Hng'))

WebUI.setText(findTestObject('Object Repository/Page_Ci t ti khon - Phan Thanh Vit/input_nhn vo y_select2-search__field'), 
    'Minh')

WebUI.sendKeys(findTestObject('Object Repository/Page_Ci t ti khon - Phan Thanh Vit/input_nhn vo y_select2-search__field'), 
    Keys.chord(Keys.ENTER))

WebUI.rightClick(findTestObject('Object Repository/Page_Ci t ti khon - Phan Thanh Vit/div_Cp nht trng thnh cng'))

WebUI.verifyTextPresent('Cập nhật trường thành công', false)
