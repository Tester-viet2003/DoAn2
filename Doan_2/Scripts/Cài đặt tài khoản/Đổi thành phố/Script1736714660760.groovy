...
WebUI.click(findTestObject('Object Repository/Page_Thng tin ti khon - Phan Thanh Vit/a_Ci t ti khon'))

WebUI.click(findTestObject('Object Repository/Page_Ci t ti khon - Phan Thanh Vit/span_Hng Yn'))

WebUI.setText(findTestObject('Object Repository/Page_Ci t ti khon - Phan Thanh Vit/input_concat(id(, , select2-82ht-container,_32a209'), 
    'Thái bình')

WebUI.sendKeys(findTestObject('Object Repository/Page_Ci t ti khon - Phan Thanh Vit/input_concat(id(, , select2-82ht-container,_32a209'), 
    Keys.chord(Keys.ENTER))

WebUI.verifyTextPresent('Vui lòng chọn giá trị', false)

WebUI.verifyTextPresent('Cập nhật tỉnh/thành thành công', false)
